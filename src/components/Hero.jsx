    ...
    return (
        <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
                ...
                <div className='flex flex-row justufy-between items-center w-full'>
                    <h1 className='flex-1 font-poppins font-semiblod ss:text-[72px] text-[52px] text-white ss:leading-[100px]'>
                ...
                <h1 className='flex-1 font-poppins font-semiblod ss:text-[68px] 
                    text-[52px] text-white ss:leading-[75px] w-full' >
                    Payment Method.
                </h1>
